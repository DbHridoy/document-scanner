...
// // The new SDK uses a 'Client' structure
...
//     // In 2026, 'gemini-3-flash-preview' is the standard free-tier workhorse
...
//   } catch (error: any) {
//     // If you see 'limit: 0' here, see the Quota section below
